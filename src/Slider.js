...
export default function Slider(){
   ...
   //todo ----- tenure years activation -----
    function tenureYears(e){
        let newData = {...data}
        newData.years=e.target.value;
        setData(newData);
    }
        ...
        <div className='container'>
            <div className="slider">
                <div className="homeValue">
                    ...
                    <p className="value_amount">$ {data.homeValue}</p>
                    <input 
                        type="range" 
                        min={1000} 
                        max={10000}
                ...
                <div className="downPayment">
                    ...
                    <p className="value_amount">$ {data.downPayment}</p>
                    <input 
                        type="range" 
                        min={0} 
                        max={data.homeValue} 
                ...
                <div className="loanAmount">
                    ...
                    <p className="value_amount">$ {data.loanAmount}</p>
                    <input 
                        type="range" 
                        min={0} 
                        max={data.homeValue} 
                ...
                <div className="intRate">
                    ...
                    <p className="value_amount">% {data.rate}</p>
                    <input 
                        type="range" 
                        min= {2} 
                        max= {18} 
